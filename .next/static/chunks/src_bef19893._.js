...
function LoginPage() {
    ...
    const { user, login, loading, technicians } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    const handleLogin = ()=>{
        if (role === 'Admin') {
            if (email.toLowerCase() === 'criss2l2@gmail.com' && password === 'HoofBeat#1') {
                login({
                    email,
                    role
                });
...
_s(LoginPage, "ltRiyFnMF6y8mUBExVcFCD76t2E=", false, function() {
    return [
...
//# sourceMappingURL=src_bef19893._.js.map