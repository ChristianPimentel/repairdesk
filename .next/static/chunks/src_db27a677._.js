...
function RepairsList({ repairs, technicians, onViewDetails }) {
    ...
    const handleStatusChange = async (repairId, newStatus)=>{
        try {
            const repairRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'repairs', repairId);
            const updateData = {
                status: newStatus
            };
            if (newStatus === 'Ready') {
                updateData.readyAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serverTimestamp"])();
            }
            if (newStatus === 'Archived') {
                updateData.archivedAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serverTimestamp"])();
            }
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])(repairRef, updateData);
            toast({
...
function ArchivedRepairsList({ repairs, technicians, onViewDetails }) {
    const getTechnicianName = (techIdentifier)=>{
        ...
        // First, try to match by email, which is more reliable
    ...
    const repairsByTechnician = archivedRepairs.reduce((acc, repair)=>{
        // Correctly get the technician's name first.
        const techName = getTechnicianName(repair.assignedToName);
        // Use the retrieved name as the key for grouping.
        if (!acc[techName]) {
            acc[techName] = [];
        }
...
function RepairDetailsDialog({ repair, isOpen, onOpenChange, technicians }) {
    ...
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    const { customers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    ...
    const [repairStatusUrl, setRepairStatusUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RepairDetailsDialog.useEffect": ()=>{
            if ("object" !== 'undefined' && navigator.share) {
                setShowShare(true);
            }
            if (isOpen && repair) {
                const statusUrl = `${window.location.origin}/repair-status/${repair.id}`;
                setRepairStatusUrl(statusUrl);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qrcode$2f$lib$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].toDataURL(statusUrl).then({
                    "RepairDetailsDialog.useEffect": (url)=>setQrCodeUrl(url)
                }["RepairDetailsDialog.useEffect"]).catch({
                    "RepairDetailsDialog.useEffect": (err)=>console.error(err)
                }["RepairDetailsDialog.useEffect"]);
                const customer = customers.find({
                    "RepairDetailsDialog.useEffect.customer": (c)=>c.id === repair.customerId
                }["RepairDetailsDialog.useEffect.customer"]);
                if (customer?.phone) {
    ...
    const handleCloneRepair = async ()=>{
        try {
            ...
            const docRef = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'repairs'), {
                ...clonedData,
                status: 'Pending',
            ...
            toast({
                title: 'Repair Cloned',
                description: `A new repair for ${repair.customerName} has been created with status "Pending". A new QR code has been generated.`
            });
            onOpenChange(false);
    ...
    const handleShare = async (method)=>{
        ...
        if (method === 'whatsapp') {
            ...
            if (navigator.share) {
                ...
                toast({
                    title: 'Link Copied',
                    description: 'The repair status link has been copied to your clipboard.'
                });
            }
        }
    };
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            showShare && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                                type: "button",
                                                                size: "sm",
                                                                variant: "outline",
...
_s(RepairDetailsDialog, "rBJz1XxVDXlYxYl44/FrYAvwN3Q=", false, function() {
    return [
...
_c1 = RepairDetailsDialog;
var _c, _c1;
__turbopack_context__.k.register(_c, "WhatsAppIcon");
__turbopack_context__.k.register(_c1, "RepairDetailsDialog");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function DashboardPage() {
    _s();
    const { technicians, repairs, setRepairs } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
...
_s(DashboardPage, "A33vxYBxdNZTCTu/p4RylSyqIzM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"]
    ];
});
...
//# sourceMappingURL=src_db27a677._.js.map