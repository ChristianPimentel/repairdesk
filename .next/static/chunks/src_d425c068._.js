...
"[project]/src/app/dashboard/repairs/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function RepairDetailsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RepairDetailsPage.useEffect": ()=>{
            if (!repairId) return;
            const fetchRepair = {
                "RepairDetailsPage.useEffect.fetchRepair": async ()=>{
                    setLoading(true);
                    try {
                        ...
                        if (docSnap.exists()) {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$qrcode$2f$lib$2f$browser$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].toDataURL(statusUrl).then({
                                "RepairDetailsPage.useEffect.fetchRepair": (url)=>setQrCodeUrl(url)
                            }["RepairDetailsPage.useEffect.fetchRepair"]).catch({
                                "RepairDetailsPage.useEffect.fetchRepair": (err)=>console.error(err)
                            }["RepairDetailsPage.useEffect.fetchRepair"]);
                            const customer = customers.find({
                                "RepairDetailsPage.useEffect.fetchRepair.customer": (c)=>c.id === fetchedRepair.customerId
                            }["RepairDetailsPage.useEffect.fetchRepair.customer"]);
                            if (customer?.phone) {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "space-y-2",
                                                        children: repair.linkURLs.map((url, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                                href: url,
                                                                target: "_blank",
...
_s(RepairDetailsPage, "ZIvcjlpeMCZxJP/0KJudeb9zPaE=", false, function() {
    return [
...
_c1 = RepairDetailsPage;
var _c, _c1;
__turbopack_context__.k.register(_c, "WhatsAppIcon");
__turbopack_context__.k.register(_c1, "RepairDetailsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_d425c068._.js.map