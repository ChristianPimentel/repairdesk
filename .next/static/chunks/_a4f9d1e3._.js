...
function TechnicianCard({ technicians, setTechnicians }) {
    ...
    const handleAddTechnician = ()=>{
        ...
        toast({
            ...
            description: `${name} has been added. Temporary password: ${tempPassword}`,
            duration: 10000
        });
        setName('');
        setEmail('');
    ...
    const handleBulkAddFromText = ()=>{
            ...
            if (parts.length === 2) {
                ...
                if (name && email) {
                    if (!existingEmails.has(email.toLowerCase())) {
                        ...
                        passwordsToast += `${name}: ${tempPassword}\n`;
                    } else {
        ...
        if (newTechnicians.length > 0) {
            ...
            toast({
                title: `Bulk Add Successful (${newTechnicians.length} added)`,
...
function TechniciansPage() {
    _s();
    const { user, technicians, setTechnicians } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UserContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    if (user?.role !== 'Admin') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TechniciansPage, "55cXQzShOnMdKMr4BMuGbYleMVc=", false, function() {
    return [
...
//# sourceMappingURL=_a4f9d1e3._.js.map