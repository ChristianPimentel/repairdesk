...
function LoginPage() {
    ...
    const handleLogin = ()=>{
        if (role === 'Admin') {
            ...
            const isTechnician = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$placeholder$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["placeholderTechnicians"].some((tech)=>tech.email.toLowerCase() === email.toLowerCase());
            if (isTechnician) {
                login({
                    email,
                    role: 'Student'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b629686._.js.map