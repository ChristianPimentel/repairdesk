...
const UserProvider = ({ children })=>{
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // No longer waiting for Firebase auth state
    const [isTechnicianDialogOpen, setIsTechnicianDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const login = (userData)=>{
        // This is now a simple state setter
        setUser(userData);
    };
    const logout = ()=>{
        setUser(null);
        setFirebaseUser(null); // Clear firebaseUser on logout as well
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(UserContext.Provider, {
        value: {
            ...
            login,
            logout,
            isTechnicianDialogOpen,
            setIsTechnicianDialogOpen
        },
        children: children
    }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__76b7f779._.js.map