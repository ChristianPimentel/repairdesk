...
function LoginPage() {
    ...
    const handleLogin = ()=>{
        ...
        // For this demo, we'll use a hardcoded email based on role.
        const email = role === 'Admin' ? 'admin@repairdesk.com' : 'student@repairdesk.com';
        login({
            email,
            role
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd45e49e._.js.map